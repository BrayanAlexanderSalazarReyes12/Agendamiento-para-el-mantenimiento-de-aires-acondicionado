...
?>
  ...
  <section id="container" class="">
    ...
    <section class="wrapper">
		...
		<form id="peticiones" action="cambiar_segundo_nombre.php" method="post" onchange="categoria(this)">
			<?php echo'<p class="segundo_nombre_text">Segundo nombre: </p> <input type="text" placeholder="segundo_nombre" name="segundo_nombre" value="'.$contenido2.'" class="segundo_nombre" id="letras" disabled >'?>
			<input type="submit" value="cambiar" class="boton_nombre_dos" id="boton">
		</form>
		...
		<form id="peticiones" action="php/cambiar_segundo_apellido.php" method="post" onchange="categoria(this)">
			<?php echo'<p class="segundo_apellido_text">Segundo apellido: </p> <input type="text" placeholder="segundo_apellido" name="segundo_apellido" value="'.$contenido4.'" class="segundo_apellido" id="letras"  >'?>
			<input type="submit" value="Enviar" class="boton_apellido_dos" id="boton">
		</form>

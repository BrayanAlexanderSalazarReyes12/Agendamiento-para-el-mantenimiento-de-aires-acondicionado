...
?>
  ...
  <section id="container" class="">
    ...
    <section class="wrapper">
		...
		<form id="peticiones" action="php/cambiar_primer_apellido.php" method="post" onchange="categoria(this)">
			<?php echo'<p class="primer_apellido_text">Primer apellido: </p> <input type="text" placeholder="primer_apellido" name="primer_apellido" value="'.$contenido3.'" class="primer_apellido" id="letras"  >'?>
			<input type="submit" value="Enviar" class="boton_apellido_uno" id="boton">
		</form>

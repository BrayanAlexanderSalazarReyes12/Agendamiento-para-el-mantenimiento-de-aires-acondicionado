...
?>
  ...
  <section id="container" class="">
    ...
    <section class="wrapper">
		...
		<form id="peticiones" action="php/cambiar_primer_nombre.php" method="post" onchange="categoria(this)">
			<?php echo'<p class="primer_nombre_text">Primer nombre: </p> <input type="text" placeholder="Primer_nombre" name="primer_nombre" value="'.$contenido1.'" class="primer_nombre" id="letras">'?>
			<input type="submit" value="Enviar" class="boton_nombre_uno" id="boton">
		</form>

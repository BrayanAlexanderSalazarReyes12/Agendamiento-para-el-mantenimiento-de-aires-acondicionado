...
<head>
  ...
  <link href="css/boton_tres.css" rel="stylesheet">
  <link href="css/calendario.css" rel="stylesheet">
  <link href="css/hora.css" rel="stylesheet">
  <link href="css/boton_cuatro.css" rel="stylesheet">
  <!--fontawesome-->
...
?>
  ...
  <section id="container" class="">
    ...
    <section class="wrapper">
		<form id="mantenimiento" action="php/informe_de_peticion.php" method="post">
		<table border="4" id="myTable">
			...
			<?php
				if($nr == $a)
				{
					...
					';
					if($selecion == ""){echo'<td><input type="checkbox" value="'.$b.'" name="estado"></input></td>';}else{echo'<script type="text/javascript">
					var firstRow = document.getElementById("myTable").rows['.$b.'];
		...
		<br>
			...
			<big><b> Hora final </b></big><input type="time" id="tiempo" name="tiempo" value=""></input>
			<input type="submit" value="Enviar" class="boton" id="boton"></input>
		</form>

<?php
	...
	if($tipodeman=="En hogares con uso moderado del AC (6 - 8 horas diarias) y condiciones externas normales")
	{
		$a=date("Y-m-d",strtotime($fecha."+ 4 month"));
	}else if($tipodeman=="En hogares con uso intensivo del AC (10 - 24 horas diarias) y condiciones externas normales"){
		$a=date("Y-m-d",strtotime($fecha."+ 3 month"));
	}else if($tipodeman=="En oficinas, bodegas, restaurante o empresas, hospitales, universidades y demas entidades"){
		$a=date("Y-m-d",strtotime($fecha."+ 1 month"));
	}else if($tipodeman=="Si nuestro aire acondicionado tiene un largo periodo sin uso, nuestra recomendación es realizar un mantenimiento previo antes de encender"){
		$a=date("Y-m-d",strtotime($fecha."+ 4 month"));
	}
                            ...
                            <tbody>
                              <tr>
                                <td class="font32" style="font-size: 46px; color: #ffffff; text-align: center; font-family: Helvetica, Arial, sans-serif; line-height: 56px; font-weight: bold; vertical-align: top;" align="center" width="100%">
                                  <span class="font44" style="color: #ffffff;">Su servico de mantenimiento de aire acondicionado ha sido aprobado por el tecnico</span> 
                                  <br>
                                  <span class="font44" style="color: #ffffff; font-weight: 100;">Tecnico: '.$contenido1.' '.$contenido2.' '.$contenido3.' '.$contenido4.'</span>.
                                  </br>
								  <br>
                                  <span class="font44" style="color: #ffffff; font-weight: 100;">Equipos para el mantenimiento: '.$cantidad.'</span>.
                                  </br>
								  <br>
                                  <span class="font44" style="color: #ffffff; font-weight: 100;">Tipo de mantenimiento: '.$tipodeman.'</span>.
                                  </br>
								  <br>
                                  <span class="font44" style="color: #ffffff; font-weight: 100;">Fecha del mantenimiento: '.$fecha.'</span>.
                                  </br>
								  <br>
                                  <span class="font44" style="color: #ffffff; font-weight: 100;">Hora de mantenimiento: '.$hora.'</span>.
                                  </br>
								  <br>
                                  <span class="font44" style="color: #ffffff; font-weight: 100;">Proximo mantenimiento: '.$a.'</span>.
                                  </br>
                                </td>
                              </tr>
                            </tbody>
...
<br>';
        ...
        if(mail($correo,'Fecha de mantenimiento de los equipos de aire acondicionado',$cuerpo,$headers)){
    		
			$sql="UPDATE peticiones
			SET proximomantenimiento = '".$a."', Hora= '".$hora."',estadodemantenimiento='la fecha de mantenimiento es:".$fecha."',selecionada='true',nombretec='".$contenido1 . $contenido2 . $contenido3 . $contenido4."'
			WHERE id = '".$estado."'";
    		...
    		echo "<script>alert('El sitio web esperimenta fallos a la hora de hagendar la fecha y hora del mantenimiento');</script>";
			echo'<script type="text/javascript">
					window.location.href="http://localhost/isi/ver_peticiones.php";
				</script>';
    	}

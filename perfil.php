...
?>
  ...
  <section id="container" class="">
    ...
    <section class="wrapper">
		...
		<form id="imagenes_de_login" action="" method="post" onchange="categoria(this)">
			<?php
				$servername = "localhost";
				$username = "sistema_de_mantenimiento";
				$password = "sistemademantenimiento";
			...
			while($mostrar = $rs -> fetch_array()){
			?>
				<img height="100px" style="transform: translate(350px,50px);" src="data:image/jpg;base64,<?php echo base64_encode($mostrar['imagen']);?>"/>
			<?php
			}
			?>
		</form>
